...
public class Zombie : MonoBehaviour
{
    ...
    [SerializeField] UnityEngine.Object[] _bloodPrefabs;
    ...
    void SpawnBlood()
    {
        ...
        int bloodPrefabIndex = r.Next(0, _bloodPrefabs.Length - 1);
        Instantiate(_bloodPrefabs[bloodPrefabIndex], transform.position - transform.forward, transform.rotation);
    }
